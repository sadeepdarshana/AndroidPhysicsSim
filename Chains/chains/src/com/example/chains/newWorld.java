 ...
 */
public class newWorld extends PhysicsWorld {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public newWorld(final int pStepsPerSecond, final Vector2 pGravity, final boolean pAllowSleep) {
		this(pStepsPerSecond, Integer.MAX_VALUE, pGravity, pAllowSleep);
	}

	public newWorld(final int pStepsPerSecond, final int pMaximumStepsPerUpdate, final Vector2 pGravity, final boolean pAllowSleep) {
		super(pGravity, pAllowSleep);
		this.mTimeStep = 1.0f / pStepsPerSecond;
		this.mMaximumStepsPerUpdate = pMaximumStepsPerUpdate;
	}

	public newWorld(final int pStepsPerSecond, final Vector2 pGravity, final boolean pAllowSleep, final int pVelocityIterations, final int pPositionIterations) {
		this(pStepsPerSecond, Integer.MAX_VALUE, pGravity, pAllowSleep, pVelocityIterations, pPositionIterations);
	}

	public newWorld(final int pStepsPerSecond, final int pMaximumStepsPerUpdate, final Vector2 pGravity, final boolean pAllowSleep, final int pVelocityIterations, final int pPositionIterations) {
	...
	public void onUpdate(final float pSecondsElapsed) {
		...
		while(this.mSecondsElapsedAccumulator >= stepLength && stepsAllowed > 0) {
			if(!paused)world.step(stepLength, velocityIterations, positionIterations);
	...
	public  void pausephys(){
		paused=true;
	}
	public  void playphys(){
		paused=false;
	}
	// ===========================================================
	// Methods
